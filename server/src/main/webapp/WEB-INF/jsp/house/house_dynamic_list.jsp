            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        ...
                        <a href="admin/house/dynamic/edit?houseId=${houseId}" class="btn btn-outline btn-primary btn-lg"
    ...
    $houseDynamic = {
        ...
        fn: {
            ...
            add: function (id) {
                ...
                window.location.href = "${contextPath}/admin/house/dynamic/edit?houseId=${houseId}"+id;
            },
            del: function (id) {
